...
const inExPortStorageAPI = require('./api/inExPortStorage');
const loginHistoryAPI = require('./api/loginHistory');
...
app.use('/api/inExPortStorage', inExPortStorageAPI);
app.use('/api/loginHistory', loginHistoryAPI);
